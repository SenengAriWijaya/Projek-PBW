        ...
        <div class="row">
            <div class="col-md-5">
                <div class="single-product-img">
                    <img src="/assets/img/products/Resistor 1k.jpg" alt="">
                </div>
            </div>
            <div class="col-md-7">
                <div class="single-product-content">
                    <h3>Resistor 1K</h3>
                    <p class="single-product-pricing"><span>Per 1 Pcs</span> Rp100</p>
                    <p>Resistor adalah komponen elektronika yang bersifat menghambat arus listrik. Resistor termasuk dalam komponen pasif karena komponen ini tidak membutuhkan arus listrik untuk bekerja.</p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="single-product-item">
                    <div class="product-image">
                        <a href="<?php echo site_url('Single_Product2'); ?>"><img src="/assets/img/products/Kapasitor Polyster.jpg" alt=""></a>
                    </div>
