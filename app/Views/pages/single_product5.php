        ...
        <div class="row">
            <div class="col-md-5">
                <div class="single-product-img">
                    <img src="/assets/img/products/Kit_Counter_Up.jpg" alt="">
                </div>
            </div>
            <div class="col-md-7">
                <div class="single-product-content">
                    <h3>Kit Flip FLop</h3>
                    <p class="single-product-pricing"><span>Per 1 Pcs</span> Rp20.000</p>
                    <p>Kit Flip-Flop adalah rangkain kit yang berisi komponen untuk rangkaian Flip-Flop. Sudah termasuk PCB beserta panduannya.
                        Fungsi kit ini untuk mempermudah pemula dalam mempelajari tentang Flip-Flop.</p>
